      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">Gestión de tareas de mantenimiento</p>
          </div>
          <button
        ...
        {workOrders.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-12 text-center dark:border dark:border-gray-700">
            <FiClipboard className="w-16 h-16 text-gray-400 dark:text-gray-500 mx-auto mb-4" />
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{wo.title}</h3>
                    </div>
                    <span

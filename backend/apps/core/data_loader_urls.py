...
from .data_loader_views import load_production_data, check_production_data, activate_admin_user, debug_admin_user, fix_vehicle_types, setup_telegram_bot
...
urlpatterns = [
    ...
    path('fix-vehicle-types/', fix_vehicle_types, name='fix-vehicle-types'),
    path('setup-telegram/', setup_telegram_bot, name='setup-telegram'),
]
